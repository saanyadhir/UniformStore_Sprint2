...
import com.appname.pages.US_ShippingPages;
...
public class US_ShippingTestCase {
	static WebDriver driver;
	static US_ShippingPages RETdminlogin; 
	...
	public void initdriver()
	{
    	...
    	RETdminlogin=new US_ShippingPages(driver);
...
{
	RETdminlogin.SstatusFilter();
}

@Test(priority=6)
public void enddate()
{
	RETdminlogin.SstatusFilterend();
}

@Test(priority=7)
public void group()
{
	RETdminlogin.SstatusFiltergroup();
}

@Test(priority=8)
public void order()
{
	RETdminlogin.SstatusFilterstatus();
}
