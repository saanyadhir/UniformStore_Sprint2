...
import com.appname.pages.US_OrdersPages;
//import com.appname.pages.UniformAdminLoginPage;
...
public class US_OrdersTestCase {
	static WebDriver driver;
	static US_OrdersPages RETdminlogin; 
	...
	public void initdriver()
	{
    	...
    	RETdminlogin=new US_OrdersPages(driver);
...
public void enddate()
{
	RETdminlogin.OstatusFilter2();
}*/

@Test(priority=7)
public void group()
{
	RETdminlogin.OstatusFilter3();
}
