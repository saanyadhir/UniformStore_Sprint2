...
import org.openqa.selenium.support.ui.WebDriverWait;
    ...
    By Orderspath=By.xpath("//*[@id=\"reports\"]/ul/li[1]/ul/li[1]/a");
    
    /*By datestart= By.xpath("//*[@id=\"input-date-start\"]");
	By dateend = By.xpath("//*[@id=\"input-date-end\"]");*/
	...
	public US_OrdersPages(WebDriver driver)
	{
		this.driver =driver;
	}
...

	{
		...
		public boolean AdminLogin(String un,String pw)
		{
			...
			driver.findElement(Orderspath).click();
