...
import com.appname.pages.ordereREGEXpage;
...
public class OrdersREGEXTestCase {
...
public void regex()
{
	 //ordereREGEXpage register = new  ordereREGEXpage (driver);
	 //register.checkbeginswitha();
	ordereREGEXpage login=new ordereREGEXpage(driver);
	String cust_name_begins_with_a=login.checkbeginswitha();
	
	
	boolean b=Pattern.compile("^a.*").matcher(cust_name_begins_with_a).find();
	Assert.assertEquals(b,true );
	System.out.println(" listing out string starting with "  + cust_name_begins_with_a);
